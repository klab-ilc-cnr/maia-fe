export class EventsConstants {
    ...
    static readonly onOntologyClassElementDoubleClickEvent = "onOntologyClassElementDoubleClickEvent";
    ...
    static readonly tag_clicked_ontology_class_viewer_tile = "tag_clicked_ontology_class_viewer_tile";
}
